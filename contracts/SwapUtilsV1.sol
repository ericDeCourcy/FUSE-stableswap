...
library SwapUtilsV1 {
    ...
    uint256 public constant WITHDRAW_FEE_DECAY_TIME = 0; // TODO: this was originally set to 4 weeks, figure out if we want to keep it as 0
        ...
        for (uint256 i = 0; i < pooledTokens.length; i++) {
            ...
            if (amounts[i] != 0) {
                ...
                amounts[i] = pooledTokens[i].balanceOf(address(this)).sub(
                    beforeBalance
                );*/ //TODO: This has been changed to a simple transfer, assuming tokens don't charge fees. change it back later
